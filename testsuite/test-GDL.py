...
@pytest.mark.skipif(True, reason='http://sourceforge.net/p/gnudatalanguage/bugs/678')
def test_function_internal():
    '''Call the internal sin() function'''
    
    assert GDL.function('sin', 1.0) == math.sin(1.0)

@pytest.mark.skipif(True, reason='http://sourceforge.net/p/gnudatalanguage/bugs/377')
